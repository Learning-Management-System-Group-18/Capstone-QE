...
WebUI.click(findTestObject('User/Page_React App/button_See Detail'))

WebUI.getText(findTestObject('User/Category/verify course selected'))

WebUI.click(findTestObject('User/Category/enrol button'))
...
WebUI.click(findTestObject('User/My Course/dropdown video'))

WebUI.click(findTestObject('User/My Course/open video'))

WebUI.click(findTestObject('User/My Course/close button'))

WebUI.getText(findTestObject('User/My Course/verify video opened'))
...
WebUI.click(findTestObject('User/My Course/5 stars button'))
...
WebUI.click(findTestObject('User/Profile/edit profile button'))

WebUI.setText(findTestObject('User/Profile/phone number field'), '081584198744')

WebUI.click(findTestObject('User/Profile/save button'))

WebUI.click(findTestObject('User/Profile/logout menu'))

WebUI.click(findTestObject('User/Profile/cancel logout button'))

WebUI.getText(findTestObject('User/Profile/verify cancel login'))

WebUI.click(findTestObject('User/Profile/cancel logout button'))

WebUI.click(findTestObject('User/Profile/logout button'))

WebUI.getText(findTestObject('User/Profile/verify logout success'))
