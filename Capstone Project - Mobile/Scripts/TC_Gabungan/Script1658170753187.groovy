...
Mobile.setText(findTestObject('Object Repository/android.widget.ImageView - Username (1)'), 'lala', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.ImageView - Email'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.ImageView - Email (1)'), 'lala@gmail.com', 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/android.widget.ImageView - Password'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.ImageView - Password (1)'), 'lala1234', 0)
...
Mobile.setText(findTestObject('Object Repository/android.widget.ImageView - Email (3)'), 'lala@gmail.com', 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/android.widget.ImageView - Password (2)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.ImageView - Password (3)'), 'lala1234', 0)
